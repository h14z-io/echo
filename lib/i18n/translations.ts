...
const en: NestedStrings = {
  ...
  insights: {
    ...
    regenerateTitle: 'Regenerate insights?',
    regenerateConfirm: 'This will replace existing analysis with a new generation. Continue?',
    // Feedback
    generateFailed: 'Failed to generate insights. Please try again.',
    diagramFailed: 'Failed to generate diagram. Please try again.',
    questionFailed: 'Failed to get answer. Please try again.',
    addedToInsight: 'Added to "{name}"',
  },
  settings: {
    title: 'Settings',
...
const es: NestedStrings = {
  ...
  insights: {
    ...
    regenerateTitle: '¿Regenerar análisis?',
    regenerateConfirm: 'Esto reemplazará el análisis existente con una nueva generación. ¿Continuar?',
    // Feedback
    generateFailed: 'Error al generar análisis. Inténtalo de nuevo.',
    diagramFailed: 'Error al generar diagrama. Inténtalo de nuevo.',
    questionFailed: 'Error al obtener respuesta. Inténtalo de nuevo.',
    addedToInsight: 'Agregado a "{name}"',
  },
  settings: {
    title: 'Configuración',
...
const pt: NestedStrings = {
  ...
  insights: {
    ...
    regenerateTitle: 'Regenerar análises?',
    regenerateConfirm: 'Isso substituirá as análises existentes por uma nova geração. Continuar?',
    // Feedback
    generateFailed: 'Falha ao gerar análises. Tente novamente.',
    diagramFailed: 'Falha ao gerar diagrama. Tente novamente.',
    questionFailed: 'Falha ao obter resposta. Tente novamente.',
    addedToInsight: 'Adicionado a "{name}"',
  },
  settings: {
    title: 'Configurações',
